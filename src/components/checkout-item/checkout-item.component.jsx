...
const CheckoutItem = ({ cartItem }) => {
 ...
 const { cartItems, totalCost, addItemToCart, removeItemFromCart, clearItemFromCart } = useContext(CartContext); // this is used to access the cart state in the checkout component. It is used to get the cart items from 
